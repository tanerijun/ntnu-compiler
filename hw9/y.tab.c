...
int yylex(void);
extern int yylineno; // Add this line to resolve yylineno

struct symtab symtab[NSYMS];
int symtab_count = 0;

// Temporary storage for declaration processing
struct {
...
{
      17,     0,    -1,    18,     4,    19,     5,    -1,     3,    11,
      -1,    20,    -1,    19,    20,    -1,    21,    -1,     6,    22,
       7,    24,    12,    -1,    23,    -1,    22,    13,    23,    -1,
      11,    -1,    11,    14,    10,    15,    -1,     8,    -1,     9,
      -1
};
...
{
  "$end", "error", "$undefined", "PROGRAM_TOKEN", "BEGIN_TOKEN",
  "END_TOKEN", "DECLARE_TOKEN", "AS_TOKEN", "INTEGER_TOKEN", "REAL_TOKEN",
  "INT_LITERAL", "ID", "';'", "','", "'('", "')'", "$accept", "program",
...
{
      17,    14,     7,    20,    21,     1,    18,     5,     4,     6,
       7,    11,    16,    19,    24,     0,    15,     0,    25,    23
};

static const yytype_int8 yycheck[] =
{
       7,     5,     6,     8,     9,     3,    13,     0,    11,     4,
       6,    11,    14,    10,    15,    -1,     8,    -1,    12,    18
};
...
{
       0,     3,    17,    18,    11,     0,     4,     6,    19,    20,
      21,    11,    22,    23,     5,    20,    14,     7,    13,    10,
       8,     9,    24,    23,    15,    12
};
...
int main() {
    ...
    // Initialize current declaration tracking
    current_decl.count = 0;
